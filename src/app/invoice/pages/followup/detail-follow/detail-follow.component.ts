...
@Component({
  selector: 'app-detail-follow',
  standalone: false,
  templateUrl: './detail-follow.component.html',
  styleUrls: ['./detail-follow.component.scss']
})
export class DetailFollowComponent {
  partner: any;
  ...
  constructor(private alert: AlertService,
    ...
    public dialogRef: MatDialogRef<DetailFollowComponent>,
